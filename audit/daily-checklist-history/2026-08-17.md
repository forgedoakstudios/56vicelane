...
**Generated:** 2026-08-17 (Central Time)
...
- [ ] **2 commits sitting on `main`, unpushed, awaiting your go-ahead** —
      the internal-redirect fix (normalizes `.html`-suffixed internal links
      to clean URLs sitewide, addressing 8 of the 9 Google Search Console
      "Page with redirect"/"Redirect error" flags) and the CLAUDE.md update
      documenting the Blotato cancellation. Both built and verified on
      `main` locally; per the standing main-approval rule I haven't pushed
      either without your explicit say-so. Asked repeatedly across several
      stop-hook nudges this week — still no answer either way. Say "push
      it" (or "hold off") whenever you get a chance.
