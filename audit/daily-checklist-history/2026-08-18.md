...
**Generated:** 2026-08-18 (Central Time)
...
- [ ] **New digest-tier article drafted 2026-08-18, needs your go-ahead:**
      "Army Battalion Reportedly Offering Soldiers Days Off to Play GTA6
      If They Re-Enlist" — you personally flagged this one (news-scan's
      keyword heuristic scored it a 2, but you called it correctly as a
      real 5-6 human-interest/clickbait story). Drafted with a Trevor
      byline to match the humor angle, real hero + 2 inline images,
      `source-status: reported` (single-outlet IGN sourcing, no official
      Army confirmation). Held on this dev branch — not pushed to `main`,
      not queued to social. Say the word when you want it live.
