...
**Generated:** 2026-08-04 (Central Time)
...
- [x] **`STORE_MAINTENANCE` flipped off, 2026-08-02.** Airtable's quota
      ...
      otherwise) so purchases and profile lookups work again. Kept the flag
      in place as a manual kill switch for any future backend incident. See
      the still-open store.html/n8n gap above — that's separate, unbuilt
      work.
